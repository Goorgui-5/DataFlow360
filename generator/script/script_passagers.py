...
arrets = ['GUEULE TAPEE','GUEDIAWAYE','DIEUPPEUL', 'PIKINE','THIAROYE',
        'PARCELLE', 'DIAKHAYE','MALIKA','SACRE COEUR','FANN','OUAKAM',
        'grand yoff','yoff','sicap','sicap karack',
        'liberte 5','liberte 6', 'grand dakar'
]
