...
# Charger le CSV
df = pd.read_csv("/home/goorgui/Bureau/ODC_DEV_DATA/PROJET_DATAFLOW360/DataFLOW360/generator/batch_foot/foot.csv")
...
for i, row in df.iterrows():
    cur.execute("""
        INSERT INTO saisons (
            ...
            points, presence_moyenne, meilleur_buteur,
            gardien_de_but, remarques
        )
    ...
    """, (
        ...
        row.points, row.presence_moyenne, row.meilleur_buteur,
        row.gardien_de_but, row.remarques
    ))
